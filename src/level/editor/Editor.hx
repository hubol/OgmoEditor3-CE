...
{	
	...
	*/
	...
	public function drawLevel():Void
	{
		...
		//Grid
		if (level.currentLayer != null && level.gridVisible) draw.drawGrid(level.currentLayer.rawTemplate.gridSize, level.currentLayer.offset, level.data.size, level.camera.a, level.project.gridColor);
